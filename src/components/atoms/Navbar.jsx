...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 0) {
        setScrolling(true); // Cambia el estado a true cuando se ha realizado el scroll
      } else {
        setScrolling(false); // Cambia el estado a false cuando se encuentra en la parte superior de la página
      }
    };

     // Agrega un listener de scroll al componente
      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between font-roboto">
          ...
          <div className="hidden md:flex  space-x-10 mr-20">
            ...
            <a href="#servicios" className="hover:text-gray-400 uppercase text-base font-roboto font-black tracking-wide text-gray-800">Servicios</a>
            <a href="/galeria" target="_blank" rel="noopener noreferrer" className="hover:text-gray-400 uppercase text-base font-roboto font-black tracking-wide text-gray-800">Galería</a>
            <a href="#metodología" className="hover:text-gray-400 uppercase text-base font-roboto font-black tracking-wide text-gray-800">Metodología</a>
            <a href="#conócenos" className="hover:text-gray-400 uppercase text-base font-roboto font-black tracking-wide text-gray-800">Conócenos</a>
          </div>
