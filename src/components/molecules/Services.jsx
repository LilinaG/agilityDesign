...
function Services() {
  ...
  return (
    <div className="py-20">
      <h2 className="text-4xl font-bold text-gray-800 mt-20 mb-6 uppercase font-roboto tracking-widest flex items-center justify-center space-x-4">
          <span className="h-[4px] bg-gray-800 w-20" />           
          <span className="relative z-10">SERVICIOS</span>
          <span className="h-[4px] bg-gray-800 w-24" />
      </h2>

      <div className="flex flex-col md:flex-row justify-center space-y-8 md:space-y-0 md:space-x-8 md:mx-auto">
